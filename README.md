...
This is a source addon skeleton intended to be packed into a PBO. It persists:

- Player position, direction, loadout, damage, stance, and vehicle assignment.
- Eden and Zeus placed logistics objects by default, controlled by CBA category settings.
...
Objects placed in Eden or Zeus are persistent by default when their CBA category setting is enabled.
...
To exclude a specific object even when its category is enabled:
...
- Object Categories: cars, armor, aircraft, ships, static weapons, crates, and props.
...
- Editor and Zeus placed objects are saved when their CBA category setting is enabled.
